...
const { command, args } = buildLaboratoryCodexCommand(experiment, observerWorkspace, instrumentWorkingDirectory);
let entry = null;
try {
...
const metadata = { recordType: "protouniverse-laboratory-run/1", experimentId: experiment.id, observer: experiment.observer,
  ...
  succeeded: result.exitCode === 0 && !timedOut && !result.error, expeditionTimeoutSeconds: timeoutSeconds,
  ...
  manualClassification: null, contaminationReason: null,
