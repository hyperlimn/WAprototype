...
export function buildLaboratoryCodexCommand(experiment, observerWorkspace, instrumentWorkingDirectory, platform = process.platform) {
  const labArgs = JSON.stringify(["run", "lab:mcp", "--", "--experiment", experiment.id]);
  return {
